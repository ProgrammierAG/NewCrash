...
public class EnderiteHelmet extends Item {
    public static final String NAME_ID = "enderite_helmet";
    public static final String ENGLISH_NAME = "Enderite Helmet";
    public static final String GERMAN_NAME = "Enderite Helm";
    ...
    EnderiteHelmet() {
        super(new Properties()
                ...
                .humanoidArmor(Enderite.ARMOR_MATERIAL, ArmorType.HELMET)
                .durability(ArmorType.HELMET.getDurability(Enderite.BASE_DURABILITY))
        );
    }
