...
public class EnderiteLeggings extends Item {
    public static final String NAME_ID = "enderite_leggings";
    public static final String ENGLISH_NAME = "Enderite Leggings";
    public static final String GERMAN_NAME = "Enderite Hose";
    ...
    EnderiteLeggings() {
        super(new Properties()
                ...
                .humanoidArmor(Enderite.ARMOR_MATERIAL, ArmorType.LEGGINGS)
                .durability(ArmorType.LEGGINGS.getDurability(Enderite.BASE_DURABILITY))
        );
    }
